...
- [23_session_followups_2026-08-20.md](23_session_followups_2026-08-20.md) — точка входа для СЛЕДУЮЩЕЙ сессии после большой рабочей сессии 2026-08-20 (UPSERT-рефакторинг завершён, «Дайджест»→«Дела», кнопка SL/TP, живой баг «К сделке» на Консервативной, находка XNCM — 159 тикеров были невидимы для рекомендаций). Срочное — два непогашенных стоп-лосса в реальном П136 (CCJ/META) и всё ещё активная заглушка алертов жене; отложенное явно пользователем — экран «Счёт»/накопительный (№125), перенос «Предложений» в «Дела», методика отбора фондов (№145), и Сигнал D (портфельный трейлинг-стоп прибыли — принципы почти все согласованы, остался только выбор порога K)
