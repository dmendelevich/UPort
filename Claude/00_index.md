...
- [18_db_backup_strategy_prep.md](18_db_backup_strategy_prep.md) — новая тема: бэкапа БД сегодня нет вообще (подтверждено, не гипотеза) — ни схемы, ни данных; конспект находок и открытых вопросов для начала обсуждения принципов в новом диалоге
