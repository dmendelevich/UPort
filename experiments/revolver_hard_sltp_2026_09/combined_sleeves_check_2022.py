...
FRAMES_CACHE = CACHE_DIR / 'signal_frames_combined_sleeves_2022.pkl'
...
DOWNLOAD_START = '2020-10-01'   # ~15 мес буфера до начала теста (2022-01-03) -- хватает на SMA200
DOWNLOAD_END = "2022-10-16"
TEST_START, TEST_END = date(2022, 1, 3), date(2022, 10, 15)
...
if __name__ == '__main__':
    ...
    scenarios = [
        ...
        ('40к без урезания: 20 Револьверной + 6 Трендовой', 20, 6),
    ]
