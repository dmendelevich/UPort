        ...
        for strat in strat_rows:
            ...
            for pos in positions:
                ...
                if value_usd > overweight_threshold:
                    ...
                    # самого начала) -- в этом случае строка целиком исключается из дайджеста
                    # (`daily_digest.py`, пересмотрено 2026-08-27 -- раньше убирали только
                    # кнопку, оставляя ежедневный текст-предупреждение без возможного действия).
