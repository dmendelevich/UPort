...
class TickerEvaluator:
    ...
    #
    # OTCM убран, EDGX сверен с пулом легализации ФБ (2026-08-21, BACKLOG.md №147) -- этот
    # список (кандидаты для рекомендации) разошёлся с пулом сегрегации ФБ в utils.py:351 (кого
    # вообще стоит спрашивать у брокера) в обе стороны. EDGX -- настоящая биржа (Cboe EDGX),
    # живой пример -- CBOE (компонент S&P500) и 16 фондов из манифеста сидели с честным MIC,
    # но их FB/T212-код никогда не спрашивался (сегрегация отсекала раньше похода к брокеру) --
    # добавлен и сюда, и в пул ФБ. OTCM (внебиржевой рынок пенни-сток/делистингов) убран отсюда
    # вовсе, не добавлен в пул ФБ -- не то качество бумаг, что остальные коды, скринингу такие
    # кандидаты не нужны.
    US_EXCHANGE_CODES = ("XNYS", "XNAS", "ARCX", "XNMS", "EDGX", "XNCM", "IEXG", "XKAS", "XAST")
